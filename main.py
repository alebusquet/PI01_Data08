...
app = FastAPI( Title="Consultas sobre Plataformas", 
...
async def get_actor(plataforma:str, año:int):
    data = df_actors[(df_actors["año"] == año) & (df_actors["plataforma"] == plataforma)]["actor"]#.value_counts().head(1)
